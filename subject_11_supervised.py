...
def ssl(subject=11):
	...
	for remove_percent in arr:
		...
		for j in range(1):
			...
			tr_data = wesad_finetuning.train(subject, remove_percent=remove_percent, pretrain_checkpoints_dir=pretrain_checkpoints_dir, seed=248)
			...
			wesad_supervised.train(subject, remove_percent=remove_percent, seed=248)
